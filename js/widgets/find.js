define([
    ...
    'dojo/topic',
    'dojo/aspect',
    'dojo/text!templatesPath/find/find.html',
    'dojo/i18n!templatesPath/find/nls/resource', 
    ...
    'dijit/form/CheckBox',
    'library/xstyle/css!templatesPath/find/css/find.css',
    'library/xstyle/css!templatesPath/find/css/adw-icons.css'
], function (declare, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, domConstruct, lang, array, on, keys, Memory, topic, aspect,
             FindTemplate, i18n, TabContainer, ContentPane, DataGrid, EnhancedGrid, ItemFileWriteStore, DomParser, Standby,on,query) {

    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        widgetsInTemplate: true,
        templateString: FindTemplate,
        baseClass: 'OpenMap_find',
        imgToBind: "data:image/png;base64,",
        toolTip: "find",
        i18n: i18n,
        typeSelect: 'None',
        draw: null,
        ...
        postCreate: function () {
            ...
            this.standby = new Standby({target: 'mapDiv'});
