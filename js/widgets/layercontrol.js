define([
    ...
    "dojo/query",
    'require',
    'library/xstyle/css!templatesPath/layercontrol/css/LayerControl.css'
], function (declare,
             array,
             lang,
             topic,
    ...
    var LayerControl = declare([WidgetBase, Container], {
        ...
        _controls: {
            TileWMS: 'templatesPath/layercontrol/controls/TileWMS',
            ImageWMS: 'templatesPath/layercontrol/controls/ImageWMS'
        },
